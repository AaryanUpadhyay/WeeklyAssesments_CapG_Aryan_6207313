...
test("test4", async ({ page }) => {
  ...
  let medal = await page.locator("//span[@class='Medal-styles__Medal-sc-645148e1-1 fqHqIZ'][@data-cy='medal-main']/span[@data-cy='ocs-text-module'][@class='OcsText-styles__StyledText-sc-bf256156-0 cjPVFu text--sm-body'][text()='2']").nth(2).textContent()
  console.log(medal);
